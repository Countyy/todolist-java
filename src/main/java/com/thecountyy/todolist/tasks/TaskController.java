package com.thecountyy.todolist.tasks;
...
import com.thecountyy.todolist.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request) {
    ...
    if (task == null) {
      return ResponseEntity.status(HttpStatus.NOT_FOUND).body("A tarefa não existe");
    }
